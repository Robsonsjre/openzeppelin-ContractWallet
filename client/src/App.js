...
class App extends Component {
  ...
  decreaseCountTwo = async number => {
    const { accounts, contract } = this.state;
    await contract.methods.decreaseCounterTwo(number).send({ from: accounts[0] });
    this.getCount();
  };
        ...
        {this.state.web3 && this.state.contract && (
          <div className={styles.contracts}>
            ...
            <div className={styles.widgets}>
              <Web3Info {...this.state} />
              <CounterUI decrease={this.decreaseCount} decreaseTwo={this.decreaseCountTwo} increase={this.increaseCount} {...this.state} />
            </div>
